...
function Skills({ skills }: Props) {
  return (
    ...
    >
      <h3 className=" animate-pulse absolute top-10 uppercase tracking-[20px] text-gray-500 text-2xl">
        Skills
      </h3>

      <h3 className=" animate-pulse uppercase absolute top-24 text-gray-500 text-sm tracking-[3px] pb-28">
