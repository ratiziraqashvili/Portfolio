...
function WorkExperience({ experiences }: Props) {
  return (
    ...
    >
      ...
      <div className=" scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/80 w-full flex space-x-5 overflow-x-scroll  snap-x snap-mandatory md:mt-44 mt-24">
